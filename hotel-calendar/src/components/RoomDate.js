...
function RoomDate(props) {
    ...
    const clickHandler = (event) => {
        context.actionOpenPopup({room_id: props.room.id, date: BookingHelper.formatDate(props.day)});
    }
    ...
    return (
        ...
        //     {props.children}
        // </td>
        <td key={props.day.getTime()} style={{ "width": (props.cellWidth + "px") }} onClick={clickHandler}>
            {props.children}
        </td>
    );
}
